...
/* Error box */
define('CMTX_ERROR_NUMBER', 'ข้อผิดพลาดขออภัยที่ %d พบว่าเมื่อมีการประมวลความคิดเห็นของคุณ');
define('CMTX_ERRORS_NUMBER', 'ข้อผิดพลาดขออภัยที่ %d พบว่าเมื่อมีการประมวลความคิดเห็นของคุณ');
...
define('CMTX_ERROR_MESSAGE_SMILIES_MAX', 'ข้อความคิดเห็นประกอบด้วยภาพสัญลักษณ์แสดงอารมณ์เกินจากที่กำหนด (Max: %d)');
...
define('CMTX_ERROR_MESSAGE_MAXIMUMS', 'กรุณาเปิดใช้งานเว็บเบราเซอร์ของคุณที่จะเคารพความยาวสูงสุดเขต');
...
define('CMTX_BAN_MESSAGE_BANNED_NOW', '<p>คุณเพิ่งถูกแบน</p><p>กรณีนี้อาจเกิดขึ้นได้จากหลายสาเหตุ ได้แก่ การใช้คำหยาบ การใช้คำซึ่งตรงกับสแปม การมีพฤติกรรมอันส่อไปในทางแฮกเคอร์</p><p>หากคุณคิดว่าสิ่งที่เกิดขึ้นกับคุณนี้ ต้องมีอะไรสักอย่างผิดพลาด กรุณาติดต่อกับผู้ควบคุมดูแลพร้อมด้วยข้อมูลซึ่งเป็น IP Address ของคุณ</p>');
...
define('CMTX_BAN_REASON_NO_RESUBMIT_KEY', 'ไม่มีคีย์ส่งอีกครั้ง');
define('CMTX_BAN_REASON_INVALID_RESUBMIT_KEY', 'ที่ไม่ถูกต้องที่สำคัญอีกครั้ง');
