...
/* Sort By title */
define('CMTX_TITLE_SORT_BY', 'Classificar os comentários');
...
/* Star titles */
define('CMTX_TITLE_FULL_STAR', 'Estrela');
define('CMTX_TITLE_HALF_STAR', 'Meia estrela');
define('CMTX_TITLE_EMPTY_STAR', 'Sem estrela');
...
/* Like Dislike */
define('CMTX_TITLE_VOTE_UP', 'Marqu este comentário como legal');
define('CMTX_TITLE_VOTE_DOWN', 'Marque este comentário como ruim');
define('CMTX_VOTE_UP', 'Obrigado pelo seu voto');
define('CMTX_VOTE_DOWN', 'Obrigado pelo seu voto');
...
define('CMTX_FLAG_CONFIRM', 'Você tem certeza que quer relatar este comentário?');
