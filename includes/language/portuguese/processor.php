...
/* Error box */
define('CMTX_ERROR_NUMBER', 'Desculpe, mas %d um erro foi encontrado durante o processamento do seu comentário.');
define('CMTX_ERRORS_NUMBER', 'Desculpe, mas %d erros foram encontrados durante o processamento do seu comentário.');
...
define('CMTX_ERROR_MESSAGE_SMILIES_MAX', 'O comentário digitado possui muitos emoticons (Max: %d)');
...
define('CMTX_ERROR_MESSAGE_MAXIMUMS', 'Por favor habilite seu navegador para respeitar campo comprimentos máximos.');
...
define('CMTX_BAN_MESSAGE_BANNED_NOW', '<p>Você foi banido.</p><p>isto pode ter ocorrido devido a uma varidade de motivos, incluind xingamento, prática de spam e comportamento relacionado a tentativas de invasão (hacker).</p><p>Se você acredita que isto foi um erro, por favor contacte o administrador, citando seu endereço de IP.</p>');
