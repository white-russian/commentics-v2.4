...
/* Sort By title */
define('CMTX_TITLE_SORT_BY', 'Razvrsti komentarje');
...
/* Like Dislike */
define('CMTX_TITLE_VOTE_UP', 'Glasujte za ta komentar');
define('CMTX_TITLE_VOTE_DOWN', 'Glasujte proti temu komentarju');
define('CMTX_VOTE_UP', 'Hvala za vaš glas');
define('CMTX_VOTE_DOWN', 'Hvala za vaš glas');
...
define('CMTX_FLAG_CONFIRM', 'Ali ste prepričani, da želite prijaviti ta komentar?');
