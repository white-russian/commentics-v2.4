...
/* Error box */
define('CMTX_ERROR_NUMBER', 'Oprostite, toda %d napaka je bilo zaznana med obdelavo.');
define('CMTX_ERRORS_NUMBER', 'Oprostite, toda %d napak je bilo zaznanih med obdelavo.');
...
define('CMTX_ERROR_MESSAGE_INVALID_NAME', 'Ime se mora začeti s črko in lahko vsebuje - & . \'');
...
define('CMTX_ERROR_MESSAGE_INVALID_TOWN', 'Mesto se mora začeti s črko in lahko vsebuje - & . \'');
...
define('CMTX_ERROR_MESSAGE_COUNTRY_SEARCH', 'Izbrana država ni bila najdena. Prosimo, poskusite znova.');
...
define('CMTX_ERROR_MESSAGE_SMILIES_MAX', 'Komentar vsebuje preveč smeškov (Max: %d)');
...
define('CMTX_ERROR_MESSAGE_INCORRECT_REFERRER', 'Referer kaže, da ste komentar oddali z druge spletne strani.');
define('CMTX_ERROR_MESSAGE_MAXIMUMS', 'Prekoračitev količine podatkov v polju - prevelika dolžina polja.');
define('CMTX_ERROR_MESSAGE_HONEYPOT', 'Skrito polje, namenjeno odkrivanju robotov, je bilo izpolnjeno. Pustite ga praznega.');
define('CMTX_ERROR_MESSAGE_MIN_TIME', 'Od prejšnjega oddanega komentarja je preteklo premalo časa. Prosimo počakajte nekoliko.');
define('CMTX_ERROR_MESSAGE_MISSING_DATA', 'Nekateri pričakovani podatki manjkajo. Prosimo vnesite podatke in ponovno pošljite komentar.');

/* Messages displayed to user when banned */
define('CMTX_BAN_MESSAGE_BANNED_NOW', '<p>Pravkar smo vam onemogočili sodelovanje.</p><p>Razlogi so lahko različni, vključno s preklinjanjem, smetenjem (Spam) in zlonamernim vedenjem, npr. hekanjem.</p><p>Če menite, da po krivici, se obrnite na administratorja. Pri tem navedite vaš IP naslov.</p>');
...
define('CMTX_BAN_REASON_NO_RESUBMIT_KEY', 'Ob ponovnem pošiljanju je manjkal varnostni ključ.');
define('CMTX_BAN_REASON_INVALID_RESUBMIT_KEY', 'Napačen varnostni ključ.');
