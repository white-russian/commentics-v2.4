...
/* Error box */
define('CMTX_ERROR_NUMBER', 'Lo sentimos pero %d error ha sido encontrado al procesar su comentario.');
define('CMTX_ERRORS_NUMBER', 'Lo sentimos pero %d errores han sido encontrados al procesar su comentarios.');
...
define('CMTX_ERROR_MESSAGE_SMILIES_MAX', 'El comentario introducido tiene demasiados smilies (Max: %d)');
...
define('CMTX_ERROR_MESSAGE_MAXIMUMS', 'Por favor, activa tu navegador para poder respetar la longitud máxima de campo.');
...
define('CMTX_BAN_MESSAGE_BANNED_NOW', '<p>Su acceso ha sido prohibido.</p><p>Esto puede ser debido a varias razones, incluyendo insultos, spam y comportamientos relacionados con el hacking.</p><p>Si usted cree que esto es un error, por favor póngase en contacto con el administrador, indicando su dirección IP.</p>');
