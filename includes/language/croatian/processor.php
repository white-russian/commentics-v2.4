...
define('CMTX_ERRORS_NUMBER', 'Žao nam je, ali %d greška otkrivenih je za vrijeme obrade vašeg komentara.');
...
define('CMTX_ERROR_MESSAGE_INVALID_COUNTRY', 'Odabrana zemlja ne vrijedi. Molimo pokušajte ponovno.');
define('CMTX_ERROR_MESSAGE_COUNTRY_SEARCH', 'Odabrana zemlja nije pronađena. Molimo pokušajte ponovno.');
...
define('CMTX_ERROR_MESSAGE_SMILIES_MAX', 'Komentar sadrži previše smajlića (Max: %d)');
...
define('CMTX_ERROR_MESSAGE_INCORRECT_REFERRER', 'Prema refereru ovaj komentar ste poslali iz druge web stranice.');
define('CMTX_ERROR_MESSAGE_MAXIMUMS', 'Molimo omogućite poštivanje ​​maksimalne duljine polja u vašem web pregledniku.');
define('CMTX_ERROR_MESSAGE_HONEYPOT', 'Skriveno polje, koje se koristi za otkrivanje robota, bilo je ispunjeno. Molimo ostavite prazno.');
define('CMTX_ERROR_MESSAGE_MIN_TIME', 'Komentar je dostavljen prebrzo nakon prethodnog. Molimo sačekajte duže.');
define('CMTX_ERROR_MESSAGE_MISSING_DATA', 'Neki od očekivanih podataka nedostaju. Molimo ponovo podnesite popunjen obrazac.');

/* Messages displayed to user when banned */
define('CMTX_BAN_MESSAGE_BANNED_NOW', '<p>Upravo smo vas blokirali.</p><p>Razlozi variraju, uključujući psovanje, spam i zlonamjerno ponašanje, kao što je hekanje.</p><p>Ako smatrate da je to pogreška, molimo vas da se obratite administratoru, citirajući vašu IP adresu.</p>');
...
define('CMTX_BAN_REASON_NO_RESUBMIT_KEY', 'U ponovnog pošiljanja falio je sigurnosni ključ.');
define('CMTX_BAN_REASON_INVALID_RESUBMIT_KEY', 'Nevaljan sigurnosni ključ.');
