...
/* Sort By title */
define('CMTX_TITLE_SORT_BY', 'Sorteer de opmerkingen');
...
/* Star titles */
define('CMTX_TITLE_FULL_STAR', 'Hele Ster');
define('CMTX_TITLE_HALF_STAR', 'Halve Ster');
define('CMTX_TITLE_EMPTY_STAR', 'Lege Ster');
