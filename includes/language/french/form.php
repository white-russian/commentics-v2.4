...
define('CMTX_RECAPTCHA_NO_KEY', 'Attention: API clé manquante dans Settings -> ReCaptcha');
...
define('CMTX_TEXT_PRIVACY', 'J\'ai lu et j\'ai compris la <a href="' . cmtx_url_encode($cmtx_settings->url_to_comments_folder) . 'agreement/french/privacy_policy.html" title="Lire politique de confidentialité" target="_blank" rel="nofollow">politique de confidentialité</a>.');

/* Text displayed after terms checkbox */
define('CMTX_TEXT_TERMS', 'J\'ai lu et j\'approuve les <a href="' . cmtx_url_encode($cmtx_settings->url_to_comments_folder) . 'agreement/french/terms_and_conditions.html" title="Lire termes et conditions" target="_blank" rel="nofollow">termes et conditions</a>.');
