...
/* Error box */
define('CMTX_ERROR_NUMBER', 'Désolé mais %d erreur a été constatée lors du traitement de votre commentaire.');
define('CMTX_ERRORS_NUMBER', 'Désolé mais %d erreurs ont été constatées lors du traitement de votre commentaire.');
...
define('CMTX_ERROR_MESSAGE_SMILIES_MAX', 'Le commentaire entré contient trop de smileys (Max: %d)');
...
define('CMTX_ERROR_MESSAGE_MAXIMUMS', 'S\'il vous plaît permettre à votre navigateur Web pour respecter la longueur des champs au maximum.');
...
define('CMTX_BAN_MESSAGE_BANNED_NOW', '<p>Vous venez d\'être banni.</p><p>Cela peut être dû à une variété de raisons, y compris les jurons, le spamming et les comportements liés aux hackers.</p><p>Si vous pensez que c\'était une erreur, Veuillez contacter l\'administrateur en indiquant votre adresse IP.</p>');
