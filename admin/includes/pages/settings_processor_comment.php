...
mysql_query("UPDATE `" . $cmtx_mysql_table_prefix . "settings` SET `value` = '$approve_images' WHERE `title` = 'approve_images'");
mysql_query("UPDATE `" . $cmtx_mysql_table_prefix . "settings` SET `value` = '$approve_videos' WHERE `title` = 'approve_videos'");
mysql_query("UPDATE `" . $cmtx_mysql_table_prefix . "settings` SET `value` = '$comment_parser_convert_links' WHERE `title` = 'comment_parser_convert_links'");
mysql_query("UPDATE `" . $cmtx_mysql_table_prefix . "settings` SET `value` = '$comment_parser_convert_emails' WHERE `title` = 'comment_parser_convert_emails'");
mysql_query("UPDATE `" . $cmtx_mysql_table_prefix . "settings` SET `value` = '$comment_links_new_window' WHERE `title` = 'comment_links_new_window'");
mysql_query("UPDATE `" . $cmtx_mysql_table_prefix . "settings` SET `value` = '$comment_links_nofollow' WHERE `title` = 'comment_links_nofollow'");
mysql_query("UPDATE `" . $cmtx_mysql_table_prefix . "settings` SET `value` = '$comment_minimum_characters_san' WHERE `title` = 'comment_minimum_characters'");
mysql_query("UPDATE `" . $cmtx_mysql_table_prefix . "settings` SET `value` = '$comment_minimum_words_san' WHERE `title` = 'comment_minimum_words'");
...
mysql_query("UPDATE `" . $cmtx_mysql_table_prefix . "settings` SET `value` = '$comment_maximum_lines_san' WHERE `title` = 'comment_maximum_lines'");
mysql_query("UPDATE `" . $cmtx_mysql_table_prefix . "settings` SET `value` = '$comment_maximum_smilies_san' WHERE `title` = 'comment_maximum_smilies'");
mysql_query("UPDATE `" . $cmtx_mysql_table_prefix . "settings` SET `value` = '$long_word_length_to_deny_san' WHERE `title` = 'long_word_length_to_deny'");
mysql_query("UPDATE `" . $cmtx_mysql_table_prefix . "settings` SET `value` = '$comment_line_breaks' WHERE `title` = 'comment_line_breaks'");
mysql_query("UPDATE `" . $cmtx_mysql_table_prefix . "settings` SET `value` = '$swear_word_masking_san' WHERE `title` = 'swear_word_masking'");
mysql_query("UPDATE `" . $cmtx_mysql_table_prefix . "settings` SET `value` = '$detect_link_in_comment_enabled' WHERE `title` = 'detect_link_in_comment_enabled'");
mysql_query("UPDATE `" . $cmtx_mysql_table_prefix . "settings` SET `value` = '$link_in_comment_action_san' WHERE `title` = 'link_in_comment_action'");
mysql_query("UPDATE `" . $cmtx_mysql_table_prefix . "settings` SET `value` = '$check_capitals_enabled' WHERE `title` = 'check_capitals_enabled'");
mysql_query("UPDATE `" . $cmtx_mysql_table_prefix . "settings` SET `value` = '$check_capitals_percentage_san' WHERE `title` = 'check_capitals_percentage'");
mysql_query("UPDATE `" . $cmtx_mysql_table_prefix . "settings` SET `value` = '$check_capitals_action_san' WHERE `title` = 'check_capitals_action'");
mysql_query("UPDATE `" . $cmtx_mysql_table_prefix . "settings` SET `value` = '$check_repeats_enabled' WHERE `title` = 'check_repeats_enabled'");
mysql_query("UPDATE `" . $cmtx_mysql_table_prefix . "settings` SET `value` = '$check_repeats_action_san' WHERE `title` = 'check_repeats_action'");
mysql_query("UPDATE `" . $cmtx_mysql_table_prefix . "settings` SET `value` = '$spam_words_enabled' WHERE `title` = 'spam_words_enabled'");
mysql_query("UPDATE `" . $cmtx_mysql_table_prefix . "settings` SET `value` = '$spam_words_action_san' WHERE `title` = 'spam_words_action'");
mysql_query("UPDATE `" . $cmtx_mysql_table_prefix . "settings` SET `value` = '$mild_swear_words_enabled' WHERE `title` = 'mild_swear_words_enabled'");
mysql_query("UPDATE `" . $cmtx_mysql_table_prefix . "settings` SET `value` = '$mild_swear_words_action_san' WHERE `title` = 'mild_swear_words_action'");
mysql_query("UPDATE `" . $cmtx_mysql_table_prefix . "settings` SET `value` = '$strong_swear_words_enabled' WHERE `title` = 'strong_swear_words_enabled'");
mysql_query("UPDATE `" . $cmtx_mysql_table_prefix . "settings` SET `value` = '$strong_swear_words_action_san' WHERE `title` = 'strong_swear_words_action'");
mysql_query("UPDATE `" . $cmtx_mysql_table_prefix . "settings` SET `value` = '$banned_websites_as_comment_enabled' WHERE `title` = 'banned_websites_as_comment_enabled'");
