...
<?php if ($cmtx_settings->powered_by == "off") { ?>
...
<option value='image'><?php echo CMTX_FIELD_VALUE_IMAGE ?></option>
<?php } else if ($cmtx_settings->powered_by == "image") { ?>
<option value='off'><?php echo CMTX_FIELD_VALUE_OFF ?></option>
<option value='text'><?php echo CMTX_FIELD_VALUE_TEXT ?></option>
...
<p />
<label class='layout_powered'><?php echo CMTX_FIELD_LABEL_NEW_WINDOW ?></label> <?php if ($cmtx_settings->powered_by_new_window) { ?> <input type="checkbox" checked="checked" name="powered_by_new_window"/> <?php } else { ?> <input type="checkbox" name="powered_by_new_window"/> <?php } ?>
