...
$file = "../includes/emails/" . $cmtx_settings->language_frontend . "/admin/new_comment_okay.txt";
$handle = fopen($file,"w");
...
<?php
$data = file_get_contents("../includes/emails/" . $cmtx_settings->language_frontend . "/admin/new_comment_okay.txt");
?>
...
<label class='settings_email_editor_admin_new_comment_okay'><?php echo CMTX_FIELD_LABEL_SUBJECT ?></label> <input type="text" required name="admin_new_comment_okay_subject" size="35" maxlength="250" value="<?php echo $cmtx_settings->admin_new_comment_okay_subject; ?>"/>
<p />
<label class='settings_email_editor_admin_new_comment_okay'><?php echo CMTX_FIELD_LABEL_FROM_NAME ?></label> <input type="text" required name="admin_new_comment_okay_from_name" size="20" maxlength="250" value="<?php echo $cmtx_settings->admin_new_comment_okay_from_name; ?>"/>
<p />
<label class='settings_email_editor_admin_new_comment_okay'><?php echo CMTX_FIELD_LABEL_FROM_EMAIL ?></label> <input type="email" required name="admin_new_comment_okay_from_email" size="35" maxlength="250" value="<?php echo $cmtx_settings->admin_new_comment_okay_from_email; ?>"/>
<p />
<label class='settings_email_editor_admin_new_comment_okay'><?php echo CMTX_FIELD_LABEL_REPLY_EMAIL ?></label> <input type="email" required name="admin_new_comment_okay_reply_to" size="35" maxlength="250" value="<?php echo $cmtx_settings->admin_new_comment_okay_reply_to; ?>"/>
<p /><br />
