...
<label class='task_delete_voters'><?php echo CMTX_FIELD_LABEL_ENABLED ?></label> <?php if ($cmtx_settings->task_enabled_delete_voters) { ?> <input type="checkbox" checked="checked" name="enabled"/> <?php } else { ?> <input type="checkbox" name="enabled"/> <?php } ?>
<p />
<label class='task_delete_voters'><?php echo CMTX_FIELD_LABEL_DAYS ?></label> <input type="text" required name="days" size="1" maxlength="4" value="<?php echo $cmtx_settings->days_to_delete_voters; ?>"/>
<p />
